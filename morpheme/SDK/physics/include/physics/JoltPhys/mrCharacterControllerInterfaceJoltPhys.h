...
//----------------------------------------------------------------------------------------------------------------------
  ...
  #pragma once
#endif
#ifndef MR_CHARACTER_CONTROLLER_JOLTPHYS_H
#define MR_CHARACTER_CONTROLLER_JOLTPHYS_H
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
/// \class MR::CharacterControllerInterfaceJoltPhys
/// \brief This specialization of the MR::CharacterControllerInterface class adds support for the Jolt Physics engine.
//----------------------------------------------------------------------------------------------------------------------
class CharacterControllerInterfaceJoltPhys : public CharacterControllerInterface
{
public:
  CharacterControllerInterfaceJoltPhys();
  virtual ~CharacterControllerInterfaceJoltPhys() {}

  /// Allow setting of the physics scene
  void setPhysicsScene(PhysicsSceneJoltPhys* physicsScene) { m_physicsScene = physicsScene; }
  /// Allow getting the physics scene
  PhysicsSceneJoltPhys* getPhysicsScene() { return m_physicsScene; }
...
private:
  ...
  PhysicsSceneJoltPhys* m_physicsScene;
};
} // namespace MR

//----------------------------------------------------------------------------------------------------------------------
#endif // MR_CHARACTER_CONTROLLER_JoltPhys_H
//----------------------------------------------------------------------------------------------------------------------
