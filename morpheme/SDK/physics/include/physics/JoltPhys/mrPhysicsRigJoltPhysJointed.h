...
public:
  ...
  public:
    /// \name Returns the body that simulates this part
    /// @{
  ...
  protected:
    ...
    struct CachedData
    {
      ...
      eJoltphys_d6movement motions[JPH::SixDOFConstraintSettings::EAxis::Num];
      JPH::MotorSettings swingDrive;
      JPH::MotorSettings twistDrive;
      JPH::MotorSettings slerpDrive;
    };
  ...
  static PhysicsRigJoltPhysJointed *init(
