...
//----------------------------------------------------------------------------------------------------------------------
  ...
  #pragma once
#endif
#ifndef MR_CHARACTER_CONTROLLER_KARMA_H
#define MR_CHARACTER_CONTROLLER_KARMA_H
//----------------------------------------------------------------------------------------------------------------------
#include "morpheme/mrCharacterControllerInterface.h"
#include "physics/mrCCOverrideBasics.h"
#include "physics/Karma/mrPhysicsSceneKarma.h"
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
/// \class MR::CharacterControllerInterfaceKarma
/// \brief This specialization of the MR::CharacterControllerInterface class adds support for the Karma engine.
//----------------------------------------------------------------------------------------------------------------------
class CharacterControllerInterfaceKarma : public CharacterControllerInterface
{
public:
  CharacterControllerInterfaceKarma();
  virtual ~CharacterControllerInterfaceKarma() {}
...
private:
  ...
  PhysicsSceneKarma* m_physicsScene;
};
} // namespace MR
