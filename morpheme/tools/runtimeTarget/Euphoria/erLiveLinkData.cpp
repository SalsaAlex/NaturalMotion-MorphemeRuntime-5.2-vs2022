  ...
  bool                NMP_UNUSED(stepNetwork))
{
  ...
  MR::PhysicsRigJoltPhys* physicsRig = (MR::PhysicsRigJoltPhys*) getPhysicsRig(getNetwork());
  ...
  if (physicsRig)
  {
    ...
    if (isBehavioural)
    {
      ...
      m_character = netDefRecord->m_characterDef.createInstance(
          rig,
          (MR::PhysicsRigJoltPhysRagdoll*)physicsRig,
          behaviourNetwork,
          ignoreGroups,
          !m_useProxyCharacter,
          &m_debugInterface);
